...
用於監控與分析網路流量的系統，能即時偵測可疑行為和潛在威脅，並支援異常流量偵測，強化網路資安的防禦與可視性。
...
用於監控端點裝置行為的系統，能即時偵測潛在威脅如惡意程式、異常行為和 CVE 等，並支援事件記錄和日誌分析，強化端點資安的防禦與可視性。
...
一款結合 YouTube Music 的猜歌小遊戲，玩家可依歌手和標籤篩選歌曲池，並自由新增、刪除歌曲或編輯標籤 (目前僅有作者帳號能夠異動歌曲和標籤)。
